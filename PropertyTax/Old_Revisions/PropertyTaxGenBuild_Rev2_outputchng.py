...
arcpy.env.workspace = "C:\Taxes\PropertyPayrollUpdate"
...
arcpy.MakeFeatureLayer_management(r"C:\Taxes\PropertyPayrollUpdate\Property\202101\Working\PropertyTaxGeomUnion.shp", "PropertyTaxGeomUnion")

#import Proprety Tax Gen Updates DBF for the current quarter
arcpy.MakeTableView_management(r"C:\Taxes\PropertyPayrollUpdate\Property\202101\Working\PropertyTaxGenUpdates.dbf", "PropertyTaxGenUpdates")
...
arcpy.Copy_management(r"C:\Taxes\PropertyPayrollUpdate\Property\202101\Working\PropertyTaxGeomUnion.shp", r"C:\Taxes\PropertyPayrollUpdate\Property\202101\Working\Second_Output\PropertyTaxGenOutput.shp" )

#import PropertyTaxGenOutput       
arcpy.MakeFeatureLayer_management(r"C:\Taxes\PropertyPayrollUpdate\Property\202101\Working\Second_Output\PropertyTaxGenOutput.shp", "PropertyTaxGenOutput")
