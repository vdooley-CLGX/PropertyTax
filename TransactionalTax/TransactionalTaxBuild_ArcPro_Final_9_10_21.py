...
UtilityTaxOutput=Workspace+"\\"+"UtilityTaxOutput.shp"
...
#STOP HERE AND CHECK FOR SLIVERS AND GAPS
...
arcpy.management.MakeFeatureLayer(TelcoTaxOutput, "TelcoTaxOutput")
...
arcpy.management.Copy("uniMuniCnty.shp", UtilityTaxOutput)

#import UtilityTaxOutput       
arcpy.management.MakeFeatureLayer(UtilityTaxOutput, "UtilityTaxOutput")
