...
arcpy.env.workspace = "C:\Franny\Taxes\TransactionalTaxBuild"
...
arcpy.management.MakeFeatureLayer("C:\Franny\Taxes\TransactionalTaxBuild\County.shp", "County")

#import current quarter's Muni shapefile        
arcpy.management.MakeFeatureLayer("C:\Franny\Taxes\TransactionalTaxBuild\Municipal.shp", "Muni")

#import Sales and Use Tax Updates DBF for the current quarter
arcpy.management.MakeTableView("C:\Franny\Taxes\TransactionalTaxBuild\SalesUseTaxUpdates.dbf", "SalesUseTaxUpdates")

#import Rental Tax Updates DBF for the current quarter
arcpy.management.MakeTableView("C:\Franny\Taxes\TransactionalTaxBuild\RentalTaxUpdates.dbf", "RentalTaxUpdates")

#import Telco Tax Updates DBF for the current quarter
arcpy.management.MakeTableView("C:\Franny\Taxes\TransactionalTaxBuild\TelcoTaxUpdates.dbf", "TelcoTaxUpdates")

#import Utility Tax Updates DBF for the current quarter
arcpy.management.MakeTableView("C:\Franny\Taxes\TransactionalTaxBuild\UtilityTaxUpdates.dbf", "UtilityTaxUpdates")
...
#import uniMuniCnty        
arcpy.management.MakeFeatureLayer("C:\Franny\Taxes\TransactionalTaxBuild\uniMuniCnty.shp", "uniMuniCnty")
...
arcpy.management.Copy("uniMuniCnty.shp", "C:\Franny\Taxes\TransactionalTaxBuild\SalesUseTaxOutput.shp")

#import SalesUseTaxOutput       
arcpy.management.MakeFeatureLayer("C:\Franny\Taxes\TransactionalTaxBuild\SalesUseTaxOutput.shp", "SalesUseTaxOutput")
...
arcpy.management.Copy("uniMuniCnty.shp", "C:\Franny\Taxes\TransactionalTaxBuild\RentalTaxOutput.shp")

#import RentalTaxOutput       
arcpy.management.MakeFeatureLayer("C:\Franny\Taxes\TransactionalTaxBuild\RentalTaxOutput.shp", "RentalTaxOutput")
...
arcpy.management.Copy("uniMuniCnty.shp", "C:\Franny\Taxes\TransactionalTaxBuild\TelcoTaxOutput.shp")

#import TelcoTaxOutput       
arcpy.management.MakeFeatureLayer("C:\Franny\Taxes\TransactionalTaxBuild\TelcoTaxOutput.shp", "TelcoTaxOutput")
...
arcpy.management.Copy("uniMuniCnty.shp", "C:\Franny\Taxes\TransactionalTaxBuild\UtilityTaxOutput.shp")

#import UtilityTaxOutput       
arcpy.management.MakeFeatureLayer("C:\Franny\Taxes\TransactionalTaxBuild\UtilityTaxOutput.shp", "UtilityTaxOutput")
