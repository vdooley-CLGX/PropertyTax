...
arcpy.management.MakeFeatureLayer(r"C:\Taxes\TransTaxTemp\County.shp", "County")

#import current quarter's Muni shapefile        
arcpy.management.MakeFeatureLayer(r"C:\Taxes\TransTaxTemp\Municipal.shp", "Muni")

#import Sales and Use Tax Updates DBF for the current quarter
arcpy.management.MakeTableView(r"C:\Taxes\TransTaxTemp\SalesUseTaxUpdates.dbf", "SalesUseTaxUpdates")

#import Rental Tax Updates DBF for the current quarter
arcpy.management.MakeTableView(r"C:\Taxes\TransTaxTemp\RentalTaxUpdates.dbf", "RentalTaxUpdates")

#import Telco Tax Updates DBF for the current quarter
arcpy.management.MakeTableView(r"C:\Taxes\TransTaxTemp\TelcoTaxUpdates.dbf", "TelcoTaxUpdates")

#import Utility Tax Updates DBF for the current quarter
arcpy.management.MakeTableView(r"C:\Taxes\TransTaxTemp\UtilityTaxUpdates.dbf", "UtilityTaxUpdates")
...
#import uniMuniCnty        
arcpy.management.MakeFeatureLayer(r"C:\Taxes\TransTaxTemp\uniMuniCnty.shp", "uniMuniCnty")
...
arcpy.management.Copy("uniMuniCnty.shp", r"C:\Taxes\TransTaxTemp\SalesUseTaxOutput.shp")

#import SalesUseTaxOutput       
arcpy.management.MakeFeatureLayer(r"C:\Taxes\TransTaxTemp\SalesUseTaxOutput.shp", "SalesUseTaxOutput")
...
arcpy.management.Copy("uniMuniCnty.shp", r"C:\Taxes\TransTaxTemp\RentalTaxOutput.shp")

#import RentalTaxOutput       
arcpy.management.MakeFeatureLayer(r"C:\Taxes\TransTaxTemp\RentalTaxOutput.shp", "RentalTaxOutput")
...
arcpy.management.Copy("uniMuniCnty.shp", r"C:\Taxes\TransTaxTemp\UtilityTaxOutput.shp")

#import UtilityTaxOutput       
arcpy.management.MakeFeatureLayer(r"C:\Taxes\TransTaxTemp\UtilityTaxOutput.shp", "UtilityTaxOutput")
